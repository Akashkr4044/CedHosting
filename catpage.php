...
<body>
	<?php
		...
		$res=$obj2->ShowCards($id,$obj->conn);
		$result=$obj2->ShowParent($id,$obj->conn);
		// print_r($result);
	?>
		<!---singleblog--->
				<div class="content">
						...
						echo '<div class="linux-prices">
											<div class="col-md-3 linux-price">
												...
												<div class="linux-bottom">
													...
													<h5>'.$value['annual_price'].'<span class="month">Annual price</span></h5>
													<h6><span>'.$des->free_domain.'</span>Domain</h6>
													<ul>
													<li><strong>'.$des->web_space.'</strong> Web Space</li>
													<li><strong>'.$des->band_width.'</strong> Band Width</li>
													<li><strong>'.$value['sku'].'</strong>SKU</li>
													<li><strong>'.$des->mail.' </strong>Language Support</li>
